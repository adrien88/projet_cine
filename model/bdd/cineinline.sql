...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 23 jan. 2019 à 12:04
...
--
-- Déchargement des données de la table `acteurfilms`
--
...
(3, ' Interstellar', 2014, ' science-fiction', ' Le film raconte les aventures d’un groupe d’explorateurs qui utilisent une faille récemment découverte dans l’espace-temps afin de repousser les limites humaines et partir à la conquête des distances astronomiques dans un voyage interstellaire. ', ' Christopher Nolan', ' Matthew McConaughey, Anne Hathaway, Michael Caine', 'youness', 'interstellar'),
(4, 'Le 5ème élément', 1997, 'Science-fiction', 'The fith element is coming back to save the world !', 'Luc Besson', 'Bruce Willis, Milla Jovovich', 'Adrien', 'le_5eme_ element'),
...
--
-- Déchargement des données de la table `genrefilms`
--
...
--
-- Contraintes pour la table `genrefilms`
--
ALTER TABLE `genrefilms`
  ADD CONSTRAINT `genrefilms_ibfk_1` FOREIGN KEY (`id`) REFERENCES `films` (`id`);
COMMIT;
